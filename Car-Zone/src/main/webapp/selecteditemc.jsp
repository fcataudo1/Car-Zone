...
<div style="background-color: #ebe9eb">
					...
					<table>
						...
						<table border = '1' cellspacing=5 cellpadding=5 align='center'>
							...
							<th>Nome Auto: </th>
								...
								<tr>
							<th style='text-align: center' colspan='2' align='center' bgcolor='#D6EEEE'><a href='addtocart?id=<%=l.getBname()%>&ie=<%=l.getCname()%>&ig=<%=l.getCarname() %>&ih=<%=l.getCarprice()%>&ii=<%=l.getCarquantity()%>&ij=<%=l.getCarimage()%>&N=<%=N%>'>Aggiungi al Carrello</th>
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                       <h2><b><%=  l.getCarname()%></b></h2><br>
		
		<h3>Descrizione</h3><br>
		<p><%=  l.getCarDescription() %></p>
		<h3>Prezzo: €<%=  l.getCarprice() %> </h3><br>	<%} %>	
