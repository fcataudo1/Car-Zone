...
<head>
<meta charset="UTF-8">
<title>Spedizione - Car-Zone</title>
...
<center>
	...
	<input type = "hidden" name = "CusName" value =<%=CusName %> >
            ...
            <div class = "container border" style="background-color:white">
                ...
                <div class = "row" style="justify-content: center">
                        ...
                        <div class = "col-xl-8 col-lg-1 col-md-1" style="background-color:white">
                            <br>
                            <center>
                                <img src="images/ship.webp" alt=Feedback height="400px" class= "imgh">   
                            </center><br>
	...
	<br>
<h4 class = "a ws"><b>Nome del Cliente:</b> </h4>
...
<br>
<b class = "ws"><input type = "submit" value= "Paga in Concessonaria" name = "cash">
<input type = "submit" value= "Paga Online" name = "online"> </b>
