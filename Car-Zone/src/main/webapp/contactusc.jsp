...
<head>
<meta charset="UTF-8">
<title>Contattaci - Car-Zone</title>
	...
	<br>
            ...
            <div class = "container border" style="background-color:white">
                ...
                <div class = "row" style="justify-content: center">
                       ...
                       <div class="col-xl-5 col-lg-1 col-md-1 image-container" style="background-color:white">
                            <br>
                            <center>
                                <img src="images/conimg2.jpg" alt=Picture height="450px">   
                            </center><br>
            ...
            <h4 class = "e ws"><b>Numero di Telefono : </b></h4>
            <h2><input type ="number"  name ="Contact_Number" class = "c" required></h2>
            
            <h4 class = "d ws"><b>Messaggio : </b></h4>
            <h2><textarea rows="5" name = "Message"></textarea><br></h2>
            <br>
	
			
		            <h3><b><input type ="submit" name="b1" value ="Invia"></b></h3>
