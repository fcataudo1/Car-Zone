<%@page import="carzone.com.entity.customer"%>
...
<head>
<meta charset="UTF-8">
<title>Gestione Clienti - Car-Zone</title>
	...
	<div class = "container">
		...
		<%
			...
			<tr>
				...
				<td style='border: 1px solid ; text-align: center'><%= c.getContact_Number() %></td>
