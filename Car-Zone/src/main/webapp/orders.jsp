...
<div style="background-color: #ebe9eb">	
	...
	<thead>
		<tr style='background-color:#ebe9eb'>
			...
			<th style='border: 1px solid ; text-align: center'>Nome Cliente</th>
			<th style='border: 1px solid ; text-align: center'>Città Cliente</th>
	...
	{%>
				...
				<tr>
					...
					<td style='border: 1px solid ; text-align: center'><a href='orderdetails.jsp?id=<%=v.getDate()%>'><p style='color: firebrick'>Dettagli Ordini<p></td>
