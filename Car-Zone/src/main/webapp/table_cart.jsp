...
<head>
<meta charset="UTF-8">
<title>Carrello Admin - Car-Zone</title>
...
<th style='border: 1px solid; text-align: center'>Nome Auto</th>
	...
	{%>
			<tr>
				...
				<td style='border: 1px solid; text-align: center'><img src='images/<%=v.getCarimage() %>' height=100px weight=100px></td>
					...
					<td style='border: 1px solid ; text-align: center'><a href='removetable_cart?ie=<%=v.getCarimage()%>&id=<%=v.getName()%>'><img src = "images/delete.jpg" alt="Remove" height= 25px></td>
