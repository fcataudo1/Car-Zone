...
public class DAO4 {
	...
	// add to orders
		...
		public int addOrder_details() {
			...
			int j = 0;
			try{
				String sql = "insert into order_details(Name,bname,cname,carname,carprice,carquantity,carimage) select * from cart where Name is NULL";
				PreparedStatement ps = conn.prepareStatement(sql);
		...
		//add to orders by name
			...
			public int addOrder_details2(String st) {
				...
				int j = 0;
				try{
					String sql = "insert into order_details(Name,bname,cname,carname,carprice,carquantity,carimage) select * from cart where Name = ?";
					PreparedStatement ps = conn.prepareStatement(sql);
