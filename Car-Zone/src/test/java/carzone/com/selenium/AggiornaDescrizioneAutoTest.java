...
import java.net.URL;
public class AggiornaDescrizioneAutoTest {
  ...
  @Test
  public void aggiornaDescrizioneAuto() {
    ...
    driver.findElement(By.id("description")).sendKeys("Alfa Romeo Mito Special Edition 120 cv...");
    driver.findElement(By.cssSelector(".form-container:nth-child(2) input")).click();
  }
}
