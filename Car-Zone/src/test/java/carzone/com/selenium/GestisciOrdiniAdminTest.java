...
import java.net.URL;
public class GestisciOrdiniAdminTest {
  ...
  @Test
  public void gestisciOrdiniAdmin() {
    ...
    driver.findElement(By.linkText("Gestisci Altro")).click();
    driver.findElement(By.linkText("Dettagli Ordini")).click();
    driver.findElement(By.cssSelector("tr:nth-child(3) a > img")).click();
  }
}
