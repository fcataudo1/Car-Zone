...
String fail = null;
    ...
    for(int i = 0; i < cookies.length; i++) 
    {
        ...
        msg = "Sei stato disconnesso con successo....";
	}
        ...
        if (cookies[i].getName().equals("un")) 
    	{
            cookies[i].setMaxAge(0);
            response.addCookie(cookies[i]);
            fail = "L'email o la password sono errati.";
    	} 
        ...
        if (cookies[i].getName().equals("creg")) 
    	{
            cookies[i].setMaxAge(0);
            response.addCookie(cookies[i]);
            cregg = "Cliente registrato con successo.<br> Ora prova a fare il login.";
    	} 
	...
	<%if(cregg != null)
        ...
        <br>
        <br>
        <a href = 'customer_reg.jsp?Total=<%=Total4 %>&CusName=<%=CusName4 %>' class ="d w3-bar-item w3-button" ><h4><b>Registrati</b></h4></a>
