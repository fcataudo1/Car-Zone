					...
					<table>
						...
						<table border = '1' cellspacing=5 cellpadding=5 align='center'>
							...
							<th>Nome Prodotto: </th>
								...
								<tr>
							<th style='text-align: center' colspan='2' align='center' bgcolor='#D6EEEE'><a href='addtocartnulla?id=<%=l.getBname()%>&ie=<%=l.getCname()%>&ig=<%=l.getCarname() %>&ih=<%=l.getCarprice()%>&ii=<%=l.getCarquantity()%>&ij=<%=l.getCarimage()%>'>Aggiungi al Carrello</th>
